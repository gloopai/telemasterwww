        ...
        <div className="py-12 md:py-20">
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              Create and manage Telegram bots easily. Customize commands, support multiple languages, and monitor performance, streamlining automation. 
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Auto-Reply Management</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Set smart auto-replies with keywords or schedules. AI-driven responses with media boost engagement effortlessly.  
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Automate group verification, manage permissions, and remove inactive users to keep your community secure.  
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Schedule posts and manage channels. Publish multimedia content and track performance to engage audiences. 
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Send personalized messages to groups/channels instantly. Use templates and track delivery to maximize outreach. 
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Offer flexible subscription plans. Automate renewals and track statuses for seamless user upgrades.  
              </p>
            </article>
          </div>
        </div>
