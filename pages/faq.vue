...
<div class="mx-auto max-w-3xl px-4 py-28 sm:px-6 sm:py-32">
      ...
      <div class="space-y-6">
        <div>
          <h2 class="text-xl font-semibold">Q: Telemaster是什么？</h2>
        ...
        <div>
          <h2 class="text-xl font-semibold">Q: 如何开始使用？</h2>
          <p class="mt-2 text-gray-700">
        ...
        <div>
          <h2 class="text-xl font-semibold">Q: 是否支持多账号管理？</h2>
          <p class="mt-2 text-gray-700">
            A: 支持。你可以按工作区管理多个群组/频道与相关配置（按方案与可用性）。
          </p>
        </div>
        <div>
          <h2 class="text-xl font-semibold">Q: 如何联系客服？</h2>
          <p class="mt-2 text-gray-700">
...
useSeoMeta({
  title: "常见问题",
  description: "Telemaster 常见问题解答：产品定位、上手方式、管理范围与联系方式。",
  ogTitle: "Telemaster - 常见问题",
  ogDescription: "Telemaster 常见问题解答：产品定位、上手方式、管理范围与联系方式。",
  ogUrl: `${siteUrl}/faq`,
});
useHead({
